...
struct DoctorDashBoard: View {
    ...
    private func statCard(title: String, value: String) -> some View {
        ...
        .background(AppConfig.cardColor)
        .cornerRadius(12)
        .shadow(color: AppConfig.shadowColor, radius: 5, x: 0, y: 4) // ✅ Added Shadow
    }
    
    // **Upcoming Appointment Card**
    private func upcomingAppointmentCard(appointment: DummyAppointment) -> some View {
        ...
        .padding()
        .frame(width: screenWidth * 0.8) // ✅ Increased height to allow shadow visibility
        .frame(minHeight: 140)
        .background(AppConfig.cardColor)
        .cornerRadius(12)
        .shadow(color: AppConfig.shadowColor, radius: 6, x: 0, y: 6) // ✅ Adjusted shadow to appear at bottom
//        .clipShape(RoundedRectangle(cornerRadius: 12)) // ✅ Prevents shadow from being clipped
    }
