...
//                                }
//                                Button(action: {showingMedicineSelection = true
//                                                             
//                                                          }) {
...
//            medicineName: "njbhv ,mjhgbv,jhbgv",
//            medicineDosage: .thriceDaily,
//            medicineDuration: .tenDays
//        )
//        
                    ...
                    List {
                        ...
                        Section(header: Text("Prescription").font(.headline)) {
                            if let prescription = existingPrescription {
                                ...
                                Section(header: Text("Medicine").font(.headline)) {
    ...
    private func loadPrescription() async {
        ...
        do {
            ...
            if let prescription = prescriptions.first {
                ...
                if let duration = prescription.medicineDuration {
